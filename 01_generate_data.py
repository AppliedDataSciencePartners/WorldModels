#xvfb-run -s "-screen 0 1400x900x24" python 01_generate_data.py car_racing --total_episodes 200 --time_steps 300
...
def main(args):
    ...
    for current_env_name in envs_to_generate:
        ...
        while s < total_episodes:
            ...
            np.savez_compressed(filename, obs=obs_sequence, action=action_sequence, reward = reward_sequence, done = done_sequence)
...
if __name__ == "__main__":
  ...
  parser.add_argument('--action_refresh_rate', default = 5, type=int, help='how often to change the random action, in frames')
